...
const descriptions = [
    ...
    'Descripción del Cíborg 5: Un cíborg médico, equipado con herramientas para salvar vidas si asi lo requier el ser humano al caul lo hara maas fuerte y eficaz.',
    ...
    'Descripción del Cíborg 7_1: Una versión mejorada del Cíborg 7, con mayor precisión y velocidad.',
    'Descripción del Cíborg 8: Un cíborg con habilidades de hackeo, experto en ciberseguridad, siempre en post del ser humano.',
    'Descripción del Cíborg 9: Un cíborg con una armadura resistente, diseñado para combate cuerpo a cuerpo que pongan en peligro a los humanos.',
    'Descripción del Cíborg 10: Un cíborg con habilidades de comunicación avanzada, ideal para espionaje en defensa de los humanos.',
    'Descripción del Cíborg 11: Un cíborg con una inteligencia artificial avanzada, capaz de aprender y adaptarse rápidamente, para la yuda del ser humano.'
];
